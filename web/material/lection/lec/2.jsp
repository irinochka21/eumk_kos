  ...
  <div class="tail-bottom">
    <div id="main">
      ...
      <div id="content">
		...
		<h2 style="font-size: 26px;"><center><b>Классификация компьютерных средств обучения</b></center></h2><br><br>
		<h2>Цели занятия:</h2><br>
		<p style="font-size: 18px;">1. Дать определение КСО</p>
		<p style="font-size: 18px;">2. Рассмотреть преимущества и недостатки КСО</p>
		<p style="font-size: 18px;">3. Привести классификацию КСО</p><br>
		
		
		<center><a href="../download/pdf/Лекция 2.pdf" target="_blank"><img src="../img/02.png" width="420" height="320"  class="img1"></a></center><br>
				
			<center><a href="../download/ppt/Лекция 2.ppt"><i>Презентация лекции</a> (ppt, 2.87 Мб)
			<a href="../download/doc/Лекция 2.pdf">Конспект лекции</a> (pdf, 417 Кб)</i></center>
